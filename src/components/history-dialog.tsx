...
interface HistoryDialogProps {
    ...
    historyPast: Array<{ label?: string; timestamp: number }>;
    historyFuture: Array<{ label?: string; timestamp: number }>;
}

export function HistoryDialog({ open, onOpenChange, historyPast, historyFuture }: HistoryDialogProps) {
    return (
